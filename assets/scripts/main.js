...
class Website3DDemo {
    ...
    _Initialize() {
      ...
      const modelDiv = document.getElementById('canvas-holder');
      ...
      // this._camera.rotation.x = 90*Math.PI/180;
  
      
      this._scene = new THREE.Scene();
      
      let hemilight = new THREE.HemisphereLight( 0xffffbb, 0x080820, 0.1 );
      ...
      this._controls = new OrbitControls(
        ...
        this._controls.target.copy(new THREE.Vector3(0, 0, 0));
        
        this._LoadGLTFModel(
          '/assets/models/', 'HybridUAV.gltf');
